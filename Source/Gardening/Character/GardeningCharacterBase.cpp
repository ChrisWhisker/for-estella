...
AGardeningCharacterBase::AGardeningCharacterBase()
{
...
void AGardeningCharacterBase::BeginPlay()
{
	Super::BeginPlay();
}
...
void AGardeningCharacterBase::SetupPlayerInputComponent(class UInputComponent* PlayerInputComponent)
{
	...
	PlayerInputComponent->BindAxis("MoveForward", this, &AGardeningCharacterBase::MoveForward);
	PlayerInputComponent->BindAxis("MoveRight", this, &AGardeningCharacterBase::MoveRight);
...
void AGardeningCharacterBase::LookUpAtRate(float Rate)
{
	// calculate delta for this frame from the rate information
	AddControllerPitchInput(Rate * BaseLookUpRate * GetWorld()->GetDeltaSeconds());
}

void AGardeningCharacterBase::MoveForward(float Value)
{
...
void AGardeningCharacterBase::MoveRight(float Value)
{
	if ((Controller != nullptr) && (Value != 0.0f))
	{
